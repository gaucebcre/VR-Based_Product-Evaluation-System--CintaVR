...
for csv_filename in csv_files:
    ...
    scale_factor = 4  # Ajusta este factor para expandir la visualización
    ...
    ax.scatter(data["X"], data["Y"], color='white', alpha=0.5, s=15, label='Player trajectory')  # Ajusta el tamaño de los puntos
